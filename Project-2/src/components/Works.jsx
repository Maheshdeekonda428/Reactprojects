...
// const Works = () => {
//   return (
//     <div className='w-full flex flex-col py-20 px-8 md:px-10 gap-10
//     lg:gap-20 lg:py-20'>
//       <h4 className='text-3x1 font-bold text-block dark:text-white
//       mt-10 '>
//         Projects
//       </h4>

//       <div className='flex flex-wrap gap-10 lg:gap-20 justiy-center'>
//         {
...
//               '>
//                 <h4 className='text-2x1 text-black dark:text-white
