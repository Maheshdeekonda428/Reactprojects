...
//         <h4 className='text-3x1 font-bold text-black dark:text-white
//         mb-10 text-center'>
//             Technical Skills
//         </h4>
...
//                      rounded-full items-center hover:animate-bounce
...
//                             <div className='w-[200px] h-[10px] bg-slate-800 
//                             rounded-lg mb-1'>
//                                 <div
...
//                 p-6 rounded-x1 shadow-x1 hover:scale-125
//                 ease-in-out duration-500 mb-10 md:mb-0'>
//                     {
//                         softskills.slice(0, 5).map((s,index) => (
//                             <div key={index + s} className='flex items-center
//                             gap-3 p-4'>
...
//                 <div className='flex flex-col bg-[#000000] dark:bg-[#224cff10]
//                 p-6 rounded-x1 shadow-x1 scale-110 hover:scale-125
//                 ease-in-out duration-500 mb-10 md:mb-0'>
//                     {
        ...
        <div className='w-full flex flex-wrap gap-10 items-center justify-center '>
            ...
            data-aos-easing='ease-in-out'
                    ...
                    key={index} className='flex gap-4 shadow-lg py-2 px-6 bg-[#04133e} rounded-full items-center hover:animate-bounce ease-in-out duration-300'>
                        <div className='w-10 h-10'>
                            <img src={skill.icon}  alt="skills"className='w-full h-full rounded-full'/>
                        </div>
                        <div className='flex flex-col gap-1'>
                            <div className='flex items-center justify-between'>
                                <p className='text-md font-semibold text-black dark:text-white'>{skill.name}</p>
                                <p className='text-md font-semibold text-black dark:text-white'>{skill.value + "%" }</p>
                            </div>
                            <div className='w-[200px] h-[10px] bg-slate-800 rounded-lg mb-1'>
